...
const getAllleadData = async () => {
  ...
  try {
    ...
    toast.error("Error in getting lead information", error);
  }
...
const leadsvalue=output1.industry;

// console.log("leadsvalue",leadsvalue);x



const generateData = (numberOfRows = 25) =>
 leadsvalue.map((keyword) => ({
...
export function Table1Presentation() {
    return (
      <div className="flex flex-col overflow-auto py-4 sm:py-0 w-1/2">
...
export default AddIndustryList;
