...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  {(handleClick, open) => {
    // State variables to track the toggle state of each dropdown
    ...
    return (
      <React.Fragment>
        ...
        <a
          href="#0"
          className={`block text-slate-200 truncate transition duration-150 ${
            pathname.includes('master') ? 'hover:text-slate-200' : 'hover:text-white'
          }`}
          onClick={(e) => {
            e.preventDefault();
            sidebarExpanded ? handleClick() : setSidebarExpanded(true);
          ...
          <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
            ...
            <li className="mb-1 last:mb-0">
              <a
                ...
                className={`block transition duration-150 truncate ${
                  pathname.includes('keyword') ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200'
                }`}
                onClick={(e) => {
                  e.preventDefault();
              ...
              >
                ...
                <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                            ...
                            <div className="flex shrink-0 ml-2">
              <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 ${keywordOpen && 'rotate-180'}`} viewBox="0 0 12 12">
                <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
              </svg>
            ...
            <li className="mb-1 last:mb-0">
              <a
                href="#0"
                className={`block transition duration-150 truncate ${
                  pathname.includes('industry') ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200'
                }`}
                onClick={(e) => {
                  e.preventDefault();
              ...
              <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                            ...
                            <div className="flex shrink-0 ml-2">
              <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 ${industryOpen && 'rotate-180'}`} viewBox="0 0 12 12">
                <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
              </svg>
            </div>
                          </div>
